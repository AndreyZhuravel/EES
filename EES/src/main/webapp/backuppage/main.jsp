...
-->
			...
			width: 100px; height: 50px;">Login</button>
                    ...
                    <img src="Images/java-bnr.png" alt="User" class="avatar">
                     </div>
...
<p>
    <button id="button_checkuseraccess">Check user access</button>
</p>
...
<div id="div_result"></div>
                    ...
                    <!--
                     <label><b>Username</b></label>
                     <input type="login" id="login" placeholder="Enter Username" name="uname">

                     <label><b>Password</b></label>
                     <input type="pass" id="pass" placeholder="Enter Password" name="psw">
